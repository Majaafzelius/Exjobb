<?php include "includes/header.php" ?>
    ...
    <div class="faq-list" data-category="category1">
        ...
        <h3 class="faq">Jag har fått ett kravbrev och betalat men korten går fortfarande inte att använda. Vad gör jag?</h3>
        ...
        <h3 class="faq">Jag vill höja limiten på mitt konto.</h3>
        ...
        <h3 class="faq">Jag vill ansöka om Preem Truckkort (f.d. Såifa).</h3>
        <p class="answer">Gå till vår Preem Truck-sida och följ anvisningarna.</p>
        <h3 class="faq">Jag vill ansöka om Preem Transport-kort</h3>
        <p class="answer">Gå till vår Preem Transport-sida och följ anvisningarna.</p>
        <h3 class="faq">Jag vill ansöka om Företagskort.</h3>
        <p class="answer">Gå till våra Företagskort och följ anvisningarna.</p>
        <h3 class="faq">Hur gör jag för att få PDF-faktura via mejl?</h3>
        ...
        <h3 class="faq">Jag har råkat betala in min faktura två gånger (felaktigt inbetald faktura), hur gör jag för att få tillbaka pengarna?</h3>
        ...
        <h3 class="faq">Jag vill ändra min Pinkod/ kan jag välja pin kod?</h3>
        <p class="answer">Det går inte att välja eller ändra pinkod, tyvärr. Den skapas slumpmässigt.</p>
        <h3 class="faq">Jag behöver en ny pinkod</h3>
        ...
        <h3 class="faq">Jag måste spärra mitt kort.</h3>
    ...
    <div class="faq-list" data-category="category3">
        <h3 class="faq">Varför har min kupong försvunnit?</h3>
        ...
        <h3 class="faq">Syns mina köpta kuponger via medlemssidorna i appen?</h3>
    ...
    <div class="faq-list" data-category="category4">
        <h3 class="faq">Var kan jag ladda ner den nya företagsappen?</h3>
        <p class="answer">Du laddar ner appen Preem Företag i AppStore för iOS eller Google Play för Android</p>
        <h3 class="faq">Varför ser jag fler bolag när jag loggar in?</h3>
